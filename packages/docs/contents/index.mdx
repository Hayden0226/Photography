...
Non-PR deployments also commit standardized photo changes back to the private photo repository, sync published photos to Cloudflare R2 under the `photos/` prefix, and mirror `apps/web/dist/` into `Jackyhq/Photography-Web`.
