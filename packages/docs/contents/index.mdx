...
Jacky's Photography is a customized static photo gallery based on [Afilmory](https://github.com/Afilmory/afilmory). This repository contains the public source code for the React/Vite gallery, the photo-manifest builder, shared workspace packages, and this MDX documentation site. The source photos live in the private `Jackyhq/Photography-Photos` repository and are checked out locally as `photos/` only during builds.
